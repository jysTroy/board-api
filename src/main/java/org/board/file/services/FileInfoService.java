package org.board.file.services;

import com.querydsl.core.BooleanBuilder;
import jakarta.servlet.http.HttpServletRequest;
import lombok.RequiredArgsConstructor;
import org.board.file.constants.FileStatus;
import org.board.file.entities.FileInfo;
import org.board.file.entities.QFileInfo;
import org.board.file.exceptions.FileNotFoundException;
import org.board.file.repositories.FileInfoRepository;
import org.board.global.configs.FileProperties;
...
public class FileInfoService {
    ...
    public String getFileUrl(FileInfo item) {
        return utils.getUrl(String.format("%s/%s/%s", request.getContextPath(), properties.getUrl(), folder(item), item.getSeq() + Objects.requireNonNullElse(item.getExtension(), "")));
    }
